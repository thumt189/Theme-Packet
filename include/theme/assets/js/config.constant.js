...
app.constant('JS_REQUIRES', {
    ...
    scripts: {
        ...
        'teacherCtrl':'include/theme/assets/js/controllers/TeacherController.js',
        'subjectCtrl':'include/theme/assets/js/controllers/SubjectController.js',
        'classCtrl':'include/theme/assets/js/controllers/ClassController.js',
    },
    //*** angularJS Modules
    modules: [{
        name: 'toaster',
