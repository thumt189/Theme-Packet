...
app.factory('mainService', function ($http) {
    ...
    factory.doAction = function (uri, data) {
        var req_data;
...
app.run(['$rootScope', '$state', '$stateParams',
    function ($rootScope, $state, $stateParams) {
        ...
        $rootScope.app = {
            name: 'LAB', // name of your project
            author: '24h Code', // author's name or company name
            description: 'LAB App', // brief description
            ...
            defaultLayout: {
                ...
                logo: 'include/theme/assets/images/logo.png', // relative path of the project logo
                logoCollapsed: 'include/theme/assets/images/logo-collapsed.png' // relative path of the collapsed logo
            },
            layout: ''
        };
...
app.config(['$translateProvider',
    function ($translateProvider) {
        ...
        $translateProvider.useStaticFilesLoader({
            prefix: 'include/theme/assets/i18n/',
            suffix: '.json'
        });
